...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/FCCurrentLocationGeocoder/FCCurrentLocationGeocoder.framework"
  install_framework "$BUILT_PRODUCTS_DIR/FCIPAddressGeocoder/FCIPAddressGeocoder.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/XQDPlugin/XQDPlugin.framework"
